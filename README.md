...
## КАК СОЗДАТЬ ШКАЛУ
В программе через меню можно открыть один из примеров, и доработать его под собственные нужды. Или же создать новую шкалу с чистого листа, добавляя на нее нужные элементы.
