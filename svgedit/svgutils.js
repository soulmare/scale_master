...
svgedit.utilities.encode64 = function(input, ignore_native_function) {
	// base64 strings are 4/3 larger than the original string
    if (!ignore_native_function)
	...
	if (window.btoa && !ignore_native_function) {
...
svgedit.utilities.decode64 = function(input, ignore_native_function) {
	if(window.atob && !ignore_native_function) {
    ...
    return ignore_native_function ? output : svgedit.utilities.decodeUTF8(output);
};
...
svgedit.utilities.buildCanvgCallback = function (callCanvg) {
	return svgedit.utilities.executeAfterLoads('canvg', ['lib/rgbcolor.js', 'lib/canvg.js'], callCanvg);
};
